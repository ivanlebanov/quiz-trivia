...
export default {
  ...
  async getUsers({
    ...
    axios.get('https://trivia-quiz.xyz/users')
  ...
  async login({
    ...
    axios.post('https://trivia-quiz.xyz/auth/google', data)
      .then(dataObj => {
  ...
  async getCurrentUser({
    ...
    if (state.g_token) {
      ...
      axios.get('https://trivia-quiz.xyz/user/' + state.id)
        .then(data => {
          if (data.data) {
            if (state.g_token) {
  ...
  async addUser({
    ...
    axios.post('https://trivia-quiz.xyz/user', data)
  }
